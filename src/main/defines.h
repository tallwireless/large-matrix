...
/****************************************************************************************************************************
  ...
  Based on and modified from Arduino NTPClient Library
 (https://github.com/arduino-libraries/NTPClient) to support other boards such
 as ESP8266/ESP32, SAMD21, SAMD51, Adafruit's nRF52 boards, SAM DUE, etc. and
 Ethernet/WiFi/WiFiNINA shields
...
// If not USE_WIFI_NINA, you can USE_WIFI_CUSTOM, then include the custom WiFi
// library here
...
#if (defined(NRF52840_FEATHER) || defined(NRF52832_FEATHER) ||                 \
     defined(NRF52_SERIES) || defined(ARDUINO_NRF52_ADAFRUIT) ||               \
     defined(NRF52840_FEATHER_SENSE) || defined(NRF52840_ITSYBITSY) ||         \
     defined(NRF52840_CIRCUITPLAY) || defined(NRF52840_CLUE) ||                \
     defined(NRF52840_METRO) || defined(NRF52840_PCA10056) ||                  \
     defined(PARTICLE_XENON) || defined(NINA_B302_ublox) ||                    \
     defined(NINA_B112_ublox))
...
#define WIFI_USE_NRF528XX true
     ...
     defined(__SAMD21E18A__) || defined(__SAMD51__) ||                         \
     defined(__SAMD51J20A__) || defined(__SAMD51J19A__) ||                     \
     defined(__SAMD51G19A__) || defined(__SAMD51P19A__) ||                     \
     defined(__SAMD21G18A__))
...
#warning Using ARDUINO_ARCH_MBED
     ...
     defined(ARDUINO_RASPBERRY_PI_PICO) || defined(ARDUINO_GENERIC_RP2040) ||  \
     defined(ARDUINO_ADAFRUIT_FEATHER_RP2040))
